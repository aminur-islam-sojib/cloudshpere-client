...
const menuItems: MenuItem[] = [
  {
    icon: <img src={clubSphereLogo} className=" h-10 w-auto" />,
    label: "ClubSphere",
    href: "/",
    gradient:
...
function NavLogo(): React.JSX.Element {
  return (
    <motion.nav
      className=" rounded-r-2xl bg-white/60 dark:bg-black/60 backdrop-blur-lg border border-gray-200/80 dark:border-gray-800/80 shadow-lg dark:shadow-gray-900/20 relative overflow-hidden"
      initial="initial"
      whileHover="hover"
    >
      <motion.div
