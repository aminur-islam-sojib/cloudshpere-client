...
function MobileNav(): React.JSX.Element {
  return (
    ...
    max-sm:flex-col max-sm:items-start max-sm:gap-3 max-sm:w-full
  "
      >
        {menuItems.map((item: MenuItem) => (
          <motion.li key={item.label} className="relative max-sm:w-full">
            <motion.div
              className="
        ...
        "
            ...
            /* Mobile full width + bigger tap area */
            max-sm:w-full max-sm:py-3 max-sm:text-base
          "
